...
// 	return (
// 		<div className=" dark:bg-gray-800 dark:text-white w-full h-[91vh] px-6 flex flex-row justify-center items-center overflow-scroll md:overflow-none ">
// 			{/* Drawer */}
// 			<div className="hidden w-[40%] h-full md:flex flex-col items-center dark:bg-black/10 p-1.5 rounded-lg shadow-lg">
// 				{/* Drawer Header */}
// 				<div className="flex flex-col items-start justify-center space-y-1 space-x-4 w-full py-4 ">
// 					<h2 className="text-lg font-semibold dark:text-white font-mono border-b-2 dark:border-gray-700">
// 						Config: &nbsp;
// 					</h2>
// 					<div className="flex flex-col justify-center space-y-1 space-x-4 w-full py-4 ">
// 						<button
...
const Standard = () => {
	...
	return (
		<div className="dark:bg-gray-800 dark:text-white w-full h-[91vh] px-2 md:px-6 flex flex-col md:flex-row justify-between items-center overflow-hidden relative">
			{/* Mobile Drawer/Menu (Slide from left) */}
			<div
				className={`fixed top-0 left-0 z-30 w-64 h-full bg-white dark:bg-gray-800 transform ${
					showMenu ? "translate-x-0" : "-translate-x-full"
				} transition-transform duration-300 ease-in-out md:hidden overflow-y-auto shadow-lg`}
			>
				<div className="p-4">
					...
					{/* Config Options */}
					<h3 className="text-md font-semibold border-b dark:border-gray-700 mb-2">
						Config
					</h3>
					<div className="flex flex-col space-y-2 mb-4">
						...
						>
							...
							<svg
								...
								viewBox="0 0 24 24"
								xmlns="http://www.w3.org/2000/svg"
								className="ml-1 size-4 dark:bg-white/80 dark:rounded-xl text-white/80"
							>
								<title>WhatsApp</title>
								<path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z" />
							</svg>
			...
			{/* Mobile History (Drawer from right) */}
			<div
				className={`fixed top-0 right-0 z-30 w-64 h-full bg-white dark:bg-gray-800 transform ${
			...
			>
				<div className="p-4">
					...
					<div className="flex justify-end mb-2">
						<button
							className="inline-flex items-center justify-center bg-gray-200 border-0 py-0.5 px-2 focus:outline-none hover:bg-red-400 rounded-lg text-sm dark:bg-gray-700 dark:text-white dark:hover:bg-red-400 cursor-pointer"
							onClick={() => {
								if (calculations.length > 0) {
									dispatch(clearCalculations());
								} else {
			...
			{/* Desktop Left Drawer */}
			<div className="hidden md:flex w-[25%] lg:w-[20%] h-full flex-col items-center dark:bg-black/10 p-1.5 rounded-lg shadow-lg mr-2">
				{/* Drawer Header */}
				<div className="flex flex-col items-start justify-center space-y-1 w-full py-4">
					<h2 className="text-lg font-semibold dark:text-white font-mono border-b-2 dark:border-gray-700">
						Config:
					</h2>
					<div className="flex flex-col justify-center space-y-1 w-full py-4">
						<button
			...
			{/* Calculator */}
			<div className="w-full md:w-[50%] lg:w-[60%] h-full overflow-y-auto">
				<StandardCalculator />
			</div>

			{/* Desktop History Section */}
			<div className="hidden md:flex w-[25%] lg:w-[20%] h-full flex-col items-center dark:bg-black/10 p-1.5 rounded-lg shadow-lg ml-2">
				{/* Header */}
				<div className="flex flex-col items-end justify-center space-y-1 w-full py-4 border-b-2 dark:border-gray-700">
					<h2 className="text-lg font-semibold dark:text-white font-mono">
						History
					</h2>
					<button
						className="mr-4 inline-flex items-center justify-center bg-gray-200 border-0 py-0.5 px-2 focus:outline-none hover:bg-red-400 rounded-lg text-base dark:bg-gray-700 dark:text-white dark:hover:bg-red-400 cursor-pointer"
						onClick={() => {
							if (calculations.length > 0) {
								dispatch(clearCalculations());
							} else {
